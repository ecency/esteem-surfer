export default () => {
  return {
    ...
    template: `<button class="btn btn-sm btn-default btn-toggle-list-style" ng-class="{'active': $root.listStyle == 2}" title="{{ 'Toggle Card View' | __ }}" ng-click="toggle()"><i class="fa fa-th"></i></button>`,
